...
describe('Button (shared-ui)', () => {
  ...
  it('applies size, variant and custom classes', () => {
    ...
    expect(button).toHaveClass('px-3', 'py-1') // pill size classes
  ...
  it('forwards refs and supports custom tags', () => {
    const ref = createRef()
    render(<Button as='a' ref={ref} disabled>Link style</Button>)
    const link = screen.getByText('Link style')
