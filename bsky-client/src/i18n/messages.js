  ...
  de: {
    ...
    layout: {
      ...
      feeds: {
        ...
        managerDescription: 'Gepinnte Feeds erscheinen als Tabs in der Timeline.',
        headerCaption: 'Feeds',
        headerTitle: 'Feeds',
        managerButton: 'Feed-Manager',
        managerButtonAria: 'Feed-Manager öffnen',
        backToMine: 'Zurück zu Meine Feeds',
        backToDiscover: 'Zurück zu Entdecke neue Feeds',
        mineTitle: 'Meine Feeds',
        mineDescription: 'Alle deine gespeicherten Feeds an einem Ort.',
        mineEmpty: 'Noch keine Feeds vorhanden.',
        feedErrorLabel: 'Feed nicht geladen',
        tabMine: 'Meine Feeds',
        tabDiscover: 'Entdecke neue Feeds',
        discoverEmpty: 'Noch keine Empfehlungen verfügbar.',
        refresh: 'Aktualisieren',
        refreshing: 'Aktualisiere...',
        saveChanges: 'Änderungen speichern',
        savingChanges: 'Speichert...',
        close: 'Schliessen',
        pinnedTitle: 'Gepinnte Feeds',
        pinnedHint: 'Reihenfolge via Pfeile anpassen.',
        pinnedEmpty: 'Noch keine Feeds angepinnt.',
        savedTitle: 'Gespeicherte Feeds',
        savedHint: 'Pinne Feeds, um sie oben anzuzeigen.',
        savedEmpty: 'Keine weiteren gespeicherten Feeds vorhanden.',
        discoverTitle: 'Entdecke neue Feeds',
        discoverDescription: 'Finde Feeds aus der Community und pinne deine Favoriten.',
        discoverSearch: 'Feeds durchsuchen',
        feedFallback: 'Feed',
        byCreator: 'von @{handle}',
        likes: '{count} Likes',
        loadError: 'Fehler beim Laden',
        feedError: 'Feed konnte nicht geladen werden.',
        attach: 'Anheften',
        attached: 'Angeheftet',
        notAttached: 'Nicht angeheftet',
        pin: 'Pin',
        pinning: 'Pinne...',
        unpin: 'Unpin',
        unpinning: 'Entferne...',
      ...
      timeline: {
        ...
        feedFallback: 'Feed',
        pinnedLoading: 'Gepinnte Feeds werden geladen…',
    ...
    chat: {
      ...
      share: {
        title: 'Post senden an...',
        searchPlaceholder: 'Suche',
        loadFailed: 'Chats konnten nicht geladen werden.',
        loading: 'Chats werden geladen…',
        empty: 'Keine Chats gefunden.',
        opening: 'Öffne…',
        openFailed: 'Chat konnte nicht geöffnet werden.',
        sending: 'Sende…',
        sendFailed: 'Post konnte nicht gesendet werden.',
        searchLoading: 'Suche läuft…',
        searchFailed: 'Suche fehlgeschlagen.',
        searchEmpty: 'Keine Personen gefunden.',
        sectionChats: 'Bestehende Chats',
    ...
    skeet: {
      ...
      actions: {
        ...
        hideReply: 'Antwort für mich ausblenden',
        hideReplyAll: 'Antwort für alle ausblenden',
        hideReplyAllDisabled: 'Nur für eigene Threads verfügbar.',
        muteThreadSuccess: 'Thread stummgeschaltet.',
        muteThreadError: 'Thread konnte nicht stummgeschaltet werden.',
        muteWordsPrompt: 'Wort oder #Tag eingeben',
        muteWordsSuccess: 'Wort oder Tag wurde stummgeschaltet.',
        muteWordsError: 'Wort oder Tag konnte nicht stummgeschaltet werden.',
        hidePostSuccess: 'Post ausgeblendet.',
        hidePostError: 'Post konnte nicht ausgeblendet werden.',
        hideReplySuccess: 'Antwort ausgeblendet.',
        hideReplyError: 'Antwort konnte nicht ausgeblendet werden.',
        hideReplyAllSuccess: 'Antwort für alle ausgeblendet.',
        hideReplyAllError: 'Antwort konnte nicht ausgeblendet werden.',
        feedbackUnavailable: 'Feedback derzeit nicht verfügbar.',
        showMoreSuccess: 'Danke! Wir zeigen dir mehr davon.',
        showMoreError: 'Feedback konnte nicht gesendet werden.',
        showLessSuccess: 'Alles klar. Wir zeigen dir weniger davon.',
        showLessError: 'Feedback konnte nicht gesendet werden.',
      ...
      report: {
        ...
        notePlaceholder: 'Optionaler Kontext für das Moderationsteam.',
        cancel: 'Abbrechen',
        submit: 'Melden',
        submitting: 'Senden…',
      ...
      share: {
        ...
        embedTitle: 'Post einbetten',
        embedHint: 'Fuege den folgenden Code in deine Website ein.',
  ...
  en: {
    ...
    skeet: {
      ...
      actions: {
        ...
        hideReply: 'Hide reply for me',
        hideReplyAll: 'Hide reply for everyone',
        hideReplyAllDisabled: 'Only available for your own threads.',
        muteThreadSuccess: 'Thread muted.',
        muteThreadError: 'Thread could not be muted.',
        muteWordsPrompt: 'Enter a word or #tag',
        muteWordsSuccess: 'Word or tag has been muted.',
        muteWordsError: 'Word or tag could not be muted.',
        hidePostSuccess: 'Post hidden.',
        hidePostError: 'Post could not be hidden.',
        hideReplySuccess: 'Reply hidden.',
        hideReplyError: 'Reply could not be hidden.',
        hideReplyAllSuccess: 'Reply hidden for everyone.',
        hideReplyAllError: 'Reply could not be hidden.',
        feedbackUnavailable: 'Feedback is currently unavailable.',
        showMoreSuccess: 'Thanks! We will show you more like this.',
        showMoreError: 'Feedback could not be sent.',
        showLessSuccess: 'Got it. We will show you less like this.',
        showLessError: 'Feedback could not be sent.',
      ...
      report: {
        ...
        notePlaceholder: 'Optional context for the moderation team.',
        cancel: 'Cancel',
        submit: 'Report',
        submitting: 'Sending…',
        success: 'Report sent.',
      ...
      share: {
        ...
        embedHint: 'Paste the following code into your site.',
        embedCopy: 'Copy code',
        embedCopied: 'Copied'
      },
      translation: {
    ...
    chat: {
      ...
      share: {
        ...
        loadFailed: 'Chats could not be loaded.',
        loading: 'Loading chats…',
        empty: 'No chats found.',
        opening: 'Opening…',
        openFailed: 'Chat could not be opened.',
        sending: 'Sending…',
        sendFailed: 'Post could not be sent.',
        searchLoading: 'Searching…',
        searchFailed: 'Search failed.',
        searchEmpty: 'No people found.',
        sectionChats: 'Existing chats',
    ...
    layout: {
      ...
      feeds: {
        managerTitle: 'Feed manager',
        managerDescription: 'Pinned feeds show up as tabs in the timeline.',
        headerCaption: 'Feeds',
        headerTitle: 'Feeds',
        managerButton: 'Feed manager',
        managerButtonAria: 'Open feed manager',
        backToMine: 'Back to my feeds',
        backToDiscover: 'Back to discover feeds',
        mineTitle: 'My feeds',
        mineDescription: 'All your saved feeds in one place.',
        mineEmpty: 'No feeds available yet.',
        feedErrorLabel: 'Feed not loaded',
        tabMine: 'My feeds',
        tabDiscover: 'Discover new feeds',
        discoverEmpty: 'No recommendations available yet.',
        refresh: 'Refresh',
        refreshing: 'Refreshing...',
        saveChanges: 'Save changes',
        savingChanges: 'Saving...',
        close: 'Close',
        pinnedTitle: 'Pinned feeds',
        pinnedHint: 'Adjust order via arrows.',
        pinnedEmpty: 'No feeds pinned yet.',
        savedTitle: 'Saved feeds',
        savedHint: 'Pin feeds to show them on top.',
        savedEmpty: 'No other saved feeds available.',
        discoverTitle: 'Discover new feeds',
        discoverDescription: 'Find community feeds and pin your favorites.',
        discoverSearch: 'Search feeds',
        feedFallback: 'Feed',
        byCreator: 'by @{handle}',
        likes: '{count} likes',
        loadError: 'Failed to load',
        feedError: 'Feed could not be loaded.',
        attach: 'Pin',
        attached: 'Attached',
