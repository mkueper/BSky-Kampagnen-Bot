...
- Theme-Umschaltung in der Sidebar verbessert: Der Button zeigt jetzt eine farbliche Vorschau des nächsten Themes; die Button-Größen wurden vereinheitlicht und ein Trenner verbessert die visuelle Struktur.
