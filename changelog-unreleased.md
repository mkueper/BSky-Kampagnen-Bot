...
- **Tests:** Suche & Notifications erhielten zusätzliche Vitest-Cases (Prefix-Detection-Unit, Mentions-Re-Fetch, Reply/Quote-Buttons), bestehende Tests wurden an die aktuellen API-Parameter (`markSeen`) angepasst; der Client-Testlauf ist wieder grün.
