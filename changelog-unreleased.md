...
- **Feature:** Pane-Wechsel schreiben nun den aktuellen Abschnitt in die URL-Hash (`#/notifications`, `#/saved`, …); Direktaufrufe oder Refreshes landen dadurch auf der passenden Ansicht, ganz ohne zusätzliche Bibliothek.
